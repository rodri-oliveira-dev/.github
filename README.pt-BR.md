...
| [`.github/workflows/reusable-workflow-release.yml`](.github/workflows/reusable-workflow-release.yml) | Publica versões revisadas após um bump de `VERSION` chegar à `main`, com retry manual idempotente, tags SemVer imutáveis e aliases por major. |
